...
def test_complex_fermions_7():
    ...
    normal_order_op = op.normal_order()
    expected = ParticleOperator({"b1^ b1^ b1 b1" : 1, "b1^ b1^ b1^ b1 b1 b1" : -1, "b1^ b1^ b1^ b1^ b1 b1 b1 b1" : -2, "b1^ b1^ b1^ b1^ b1^ b1 b1 b1 b1 b1" : 1})
...
def test_complex_fermions_8():
    ...
    normal_order_op = op.normal_order()
    expected = ParticleOperator({"b1^ b1^ b1 b1" : 1, "b1^ b1^ b1^ b1 b1 b1" : -1, "b1^ b1^ b1^ b1^ b1 b1 b1 b1" : -3, "b1^ b1^ b1^ b1^ b1^ b1 b1 b1 b1 b1" : 2, "b1^ b1^ b1^ b1^ b1^ b1^ b1 b1 b1 b1 b1 b1" : 1})
...
def test_complex_fermions_9():
    ...
    normal_order_op = op.normal_order()
    expected = ParticleOperator({" " : 1, "b1^ b1" : -1, "b2^ b2" : -1, "b2^ b1^ b1 b2" : 1, "b3^ b3" : -1, "b3^ b1^ b1 b3" : 1, "b3^ b2^ b2 b3" : 1, "b3^ b2^ b1^ b1 b2 b3" : -1})
...
def test_complex_fermions_10():
    ...
    normal_order_op = op.normal_order()
    expected = ParticleOperator({" " : 1, "b1^ b1" : -1, "b1^ b1^ b1 b1" : -3, "b1^ b1^ b1^ b1 b1 b1" : 2, "b1^ b1^ b1^ b1^ b1 b1 b1 b1" : 1})
